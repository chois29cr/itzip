...
ArrayList<MypageVO> mylikelist = (ArrayList<MypageVO>)request.getAttribute("mylikelist");
...
<table style="margin-left: auto; margin-right: auto;" cellpadding="0" cellspacing="0" width="1000px" align="center">
			...
			<table border="0" width="100%">
				...
				<tr>
					<td colspan="2" style="padding:5px;">
						...
						<a class="cur_active" href="../mypage/mylike.do">좋아요</a> &nbsp;&nbsp;&nbsp;
	...
	<tr>
		<td>
			<div style="padding: 0 0 5px 0;">
				<font color="#63A6DB"><%= user.getName()%></font> 님이 좋아요를 누른 게시물 내역입니다.
			</div>
			<div style="padding: 0 0 5px 0;">
				<font color="#63A6DB"><%= mdto.mycount(user.getUno(), "mrelike", "likecheck")%></font> 개의 결과가 조회되었습니다.
			</div>
		</td>
	</tr>
	...
	<tr>
		<td>
			...
			<table border="0" class="innertable" width="100%">
				...
				<tr class="tablecol">
					<td class="mytd" colspan="3">좋아요</td>
				</tr>
				<tr>
				...
				<tr align="center">
					<td style="padding:20px 0 100px 0;"> 좋아요를 누른 게시물이 없습니다. </td>
				</tr>
				<%
				}
				%>
									...
									<table border="0" width="300px">
										...
										<tr>
											<td align="center" width="300px">
												<a href="/teamc2/01myroom/view.do?no=<%= m.getNo() %>&k=<%= k %>&t=<%= t %>&page=<%= ipageno %>">
	...
	<tr>
		<td colspan="3" align="center">	
			...
			if( ipageno > 1) {
			%>
				<a class="page_nation" href="mylike.do?page=<%= ipageno - 1 %>">이전</a>&nbsp;
			<%
			}else {
			%>
			...
			for(int y=startno; y <= endno; y++) {
				if(y==ipageno) {
			%>
					<a class="active" href="mylike.do?page=<%= y %>"><%= y %></a>&nbsp;
				<%
				}else {
				%>
					<a class="page_nation" href="mylike.do?page=<%= y %>"><%= y %></a>&nbsp;
				<%								
				}
			}
			...
			%>
				<a class="page_nation" href="mylike.do?page=<%= ipageno + 1 %>">다음</a>
			<%
			}else {
			%>
