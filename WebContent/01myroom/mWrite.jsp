...
<table style="margin-left: auto; margin-right: auto;" border="0" width="1000px" align="center">
	<tr>
		<td colspan="2" style="padding:5px;"><h2><a href="myroom.jsp">내 방</a></h2></td>
	</tr>
	<tr>
...
<!-- 글쓰기 테이블 -->
<form id="mWriteFrm" name="mWriteFrm" method="post" action="/teamc2/01myroom/write.do" enctype="multipart/form-data">
	<table id="mWriteCont" name="mWriteCont" style="margin-left: auto; margin-right: auto;" border="0" width="1000px" align="center">
		<tr>
			<td colspan="2">
				<input class="inputbox" type="text" id="title" name="title" placeholder="제목을 입력하세요." maxlength="33" oninput="numberMaxLength(this);">
			</td>
		</tr>
		<tr>
			<td>
				<table id="attachTable" name="attachTable" style="width:950px; height:400px;">
					...
					<tr>						
						<td width="495px">
							<textarea class="bodybox" id="ir1" name="ir1" style="width:100%; height:400px;"></textarea>						
						</td>
					</tr>
				</table>
			</td>
	...
	<table style="margin-left: auto; margin-right: auto;" border="0" width="1000px" align="center">				
		<tr class="labelcell">
			<td colspan="2" align="center">
				...
				<input class="buttonA" type="submit" value="등록" onclick="javascript:submitContents(this); return false;">
			</td>
		</tr>
	</table>
</form>
...
function goBoard(){
	...
	document.location.href="myroom.jsp?k=<%= k %>&page=<%= pageno %>";
}
