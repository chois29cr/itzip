...
<%
ArrayList<UserinfoVO> uList = (ArrayList<UserinfoVO>)request.getAttribute("uList");
		...
		<td>
			<table border="0" width="100%">
				...
				<tr>						
					...
					<td width="25%" align="center"><a class="cur_active" href="/teamc2/manager/oUser.do?page=1">회원관리</a></td>
	...
	<tr>
		<td>			
			...
			<table style="margin-left: auto; margin-right: auto;" border="0" class="boardtable" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="line" colspan="4" align="left">
					</td>
				</tr>
				...
				for(int i=0; i< uList.size(); i++) {
					UserinfoVO vo = (UserinfoVO)uList.get(i);
					int seqno = total - ((Integer.parseInt(pageno) - 1) * 10);
				%>
				<tr>
					<td class="line" width="100px" height="40px" align="center">
						<input type="checkbox" id="no" name="no" value="<%= vo.getType() %>:<%= vo.getUno() %>" >						
					</td>
					<td class="line" width="100px" align="center">
						<%= seqno - i %>
					</td>
