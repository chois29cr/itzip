    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/teamc2/se/photo_uploader/popup/file_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/teamc2/se/photo_uploader/popup/file_uploader.jsp',	//샘플 URL입니다.
 	        sCallback :'/teamc2/se/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
